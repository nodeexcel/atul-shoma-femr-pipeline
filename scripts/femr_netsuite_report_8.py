"""
FEMR NetSuite Report Generator (v8)
====================================
Matches the new FEMR Export Template 041526.xlsx layout.

Changes from v7 (per Josh's feedback 2026-04-17):
  - Available Funds (row 11): now formatted as currency (was plain number)
  - Chart: legend moved to right to avoid overlap with x-axis quarter labels
  - Chart: y-axis numFmt corrected (was non-standard 'number_format' attr)
  - Chart: auto-scaling enabled on y-axis so dollar values render as tick marks
...
def run(mapping_path: str, output_prefix: str,
    ...
    logger.info("=== FEMR NetSuite Report Generator (v8) ===")
